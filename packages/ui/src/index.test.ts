...
describe("package exports", () => {
  it("exposes the web design system surface", () => {
    ...
    expect(web.AssistantChatPanel).toBeDefined();
    expect(web.FloatingAssistantLauncher).toBeDefined();
    expect(web.CadenceBarChart).toBeDefined();
    expect(web.Marquee).toBeDefined();
    expect(web.KPIStatGrid).toBeDefined();
    expect(web.TimelineRow).toBeDefined();
    expect(web.ExperienceTimeline).toBeDefined();
  ...
  it("resolves the native entry without changing the public contract", async () => {
    ...
    expect(native.AssistantChatPanel).toBeDefined();
    expect(native.FloatingAssistantLauncher).toBeDefined();
    expect(native.CadenceBarChart).toBeDefined();
    expect(native.Marquee).toBeDefined();
    expect(native.KPIStatGrid).toBeDefined();
    expect(native.TimelineRow).toBeDefined();
    expect(native.ExperienceTimeline).toBeDefined();
