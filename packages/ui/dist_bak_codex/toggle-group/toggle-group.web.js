...
export function ToggleGroup({ children, className, defaultValue, disabled = false, onValueChange, type = "single", value, ...props }) {
    ...
    return (_jsx(ToggleGroupProvider, { value: context, children: _jsx("div", { className: cn("inline-flex flex-wrap items-center gap-2", className), ...props, children: children }) }));
}
