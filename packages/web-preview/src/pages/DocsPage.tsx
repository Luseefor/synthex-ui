...
import { Button, Card, CardContent, H2, Muted } from "synthex-ui/components";
  ...
  return (
    <div className="preview-docs-grid">
      <aside className="preview-page-stack">
        <div><H2>Documentation</H2><Muted>Architecture, theming, and workbench notes from the repo docs directory.</Muted></div>
