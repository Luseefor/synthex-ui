  ...
  return (
    <Card>
      ...
      <CardContent className="preview-section-stack">
        ...
        <DataTable columns={[{ id: "package", header: "Package", accessor: "package" }, { id: "surface", header: "Surface", accessor: "surface" }, { id: "status", header: "Status", accessor: "status", align: "right" }]} data={[{ package: "synthex-ui", surface: "Design system", status: "Stable" }, { package: "@synthex/core", surface: "Engine", status: "Stable" }, { package: "@synthex/react-web", surface: "Workbench", status: "Ready" }]} pageSize={3} searchKey="package" searchPlaceholder="Filter packages" />
