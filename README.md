...
- `@luseefor/synthex-core`: framework-agnostic layout and command engine
- `@luseefor/synthex-react-web`: React DOM adapter for dockable workbench rendering
...
```tsx
import { createLayoutEngine } from "@luseefor/synthex-core";
